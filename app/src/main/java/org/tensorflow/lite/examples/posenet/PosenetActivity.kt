...
class PosenetActivity :
  ...
  private fun draw(canvas: Canvas, person: Person, bitmap: Bitmap) {
    ...
    //Toast.makeText(context, "val = $cnt" , Toast.LENGTH_LONG).show()
    if(person.score > 0.7 ) {
      cnt++
      var str: String = "Task number: $cnt"
      canvas.drawText(
        "Task: %s".format(cnt),
        (15.0f * widthRatio),
...
//      canvas.drawText(
//        "x : %.2f".format(person.keyPoints[0].position.x.toFloat()),
//        (15.0f * widthRatio),
//        (50.0f * heightRatio + bottom),
//        paint
//      )
//      canvas.drawText(
//        "y : %.2f".format(person.keyPoints[0].position.y.toFloat()),
//        (15.0f * widthRatio),
...
//      )
    ...
    canvas.drawText(
      "Score: %.2f".format(person.score * 100),
      (15.0f * widthRatio),
